...
const scale_function_t SCALE_FUNCTION_TABLE[SCALE_ALGORITHM_COUNT] =
{
    &scale_pixel_dumb,
    &scale_pixel_linear
};
...
static void
scale_pixel_dumb(image_t* new_image_p, const image_t* image_p, uint32_t new_x, uint32_t new_y, float scale)
{
