...
typedef uchar*** image_t;
typedef struct point_t{int x; int y; int z; uchar blue; uchar green; uchar red;} point_t;
typedef struct camera_t{vector_t origine; vector_t direction; float distance;} camera_t;
typedef struct figure_t{uint nombre_Point; point_t* sequence;} figure_t;
